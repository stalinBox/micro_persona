...
public class SociosTipoProductorView implements java.io.Serializable {
	...
	@ApiModelProperty(value = "Campo almacena la fecha en la que el usuario realiza el ingreso de información", hidden = true)
	...
	@ApiModelProperty(value = "Campo almacena la fecha en la que hizo la actualización el usuario", readOnly = true)
	@UpdateTimestamp
	@Temporal(TemporalType.TIMESTAMP)
